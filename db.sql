...
--
-- Table structure for table `clients_tmp_webcams`
--

DROP TABLE IF EXISTS `clients_tmp_webcams`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `clients_tmp_webcams` (
  ...
  CONSTRAINT `clients_tmp_webcams_ibfk_1` FOREIGN KEY (`client_id`) REFERENCES `clients_tmp` (`id`) ON DELETE CASCADE,
  CONSTRAINT `clients_tmp_webcams_ibfk_2` FOREIGN KEY (`webcam_id`) REFERENCES `webcam` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `clients_tmp_webcams`
--

LOCK TABLES `clients_tmp_webcams` WRITE;
/*!40000 ALTER TABLE `clients_tmp_webcams` DISABLE KEYS */;
/*!40000 ALTER TABLE `clients_tmp_webcams` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-04-16 15:52:06
